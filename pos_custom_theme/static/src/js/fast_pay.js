odoo.define('pos_custom_buttons.FastPaymentButton', function(require) {
'use strict';
   ...
   class FastPaymentButton extends PosComponent {
        constructor() {
            super(...arguments);
        }
   ...
   FastPaymentButton.template = 'FastPaymentButton';
   ProductScreen.addControlButton({
        component: FastPaymentButton,
        condition: function() {
            return this.env.pos;
        },
        position: ['before', 'CustomPaymentButton'],
   });
   Registries.Component.add(FastPaymentButton);
   return FastPaymentButton;
});